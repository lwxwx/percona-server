...
#include "include/mysql/gcs/gcs_communication_interface.h"
...
#include "src/bindings/xcom/gcs_xcom_communication_protocol_changer.h"
...
#include "src/bindings/xcom/gcs_xcom_proxy.h"
