...
#include "src/bindings/xcom/xcom/synode_no.h"  // synode_eq
#include "src/bindings/xcom/xcom/xcom_base.h"  // pm_finished
#include "src/bindings/xcom/xcom/xcom_cache.h"  // pax_machine, hash_get
