...
#include "src/bindings/xcom/gcs_internal_message.h"
#include "src/bindings/xcom/gcs_message_stage_lz4.h"
#include "src/bindings/xcom/gcs_message_stage_split.h"
...
#include "src/bindings/xcom/gcs_xcom_utils.h"
