...
#include "src/bindings/xcom/gcs_xcom_communication_interface.h"
#include "include/mysql/gcs/gcs_member_identifier.h"
#include "src/bindings/xcom/gcs_xcom_utils.h"  // gcs_protocol_to_mysql_version
...
#include "include/mysql/gcs/gcs_logging_system.h"
#include "src/bindings/xcom/gcs_message_stages.h"
...
#include "src/bindings/xcom/xcom/xcom_memory.h"  // my_xdr_free
